        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="mb-3">
                        <label for="recipient-name" class="col-form-label">Service</label>
                        <input type="text" class="form-control" id="service-reserv">
                    </div>
                    <div class="mb-3">
                        <label for="recipient-name" class="col-form-label">Date</label>
                        <input type="text" class="form-control" id="date-reserv">
                    </div>
                    <div class="mb-3">
                        <label for="recipient-name" class="col-form-label">Time</label>
                        <input type="text" class="form-control" id="time-reserv">
                    </div>
                    <div class="mb-3">
                        <label for="recipient-name" class="col-form-label">Service</label>
                        <input type="text" class="form-control" id="service-reserv">
